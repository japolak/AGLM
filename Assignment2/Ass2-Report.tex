...
\end{alltt}
\begin{verbatim}
##                    logit        param   Est. Std..Errors z.stat p.value    RRR
## 1          Bird vs. Fish  (Intercept) -1.702       0.769 -2.213   0.027  0.182
## 2          Bird vs. Fish  lakeHancock  0.575       0.795  0.723   0.469  1.777
## 3          Bird vs. Fish lakeOklawaha -0.551       1.210 -0.455   0.649  0.577
## 4          Bird vs. Fish lakeTrafford  1.237       0.866  1.428   0.153  3.445
## 5          Bird vs. Fish      sexmale -0.606       0.689 -0.880   0.379  0.545
## 6          Bird vs. Fish    sizesmall -0.730       0.652 -1.120   0.263  0.482
## 7  Invertebrate vs. Fish  (Intercept) -1.167       0.534 -2.187   0.029  0.311
## 8  Invertebrate vs. Fish  lakeHancock -1.781       0.623 -2.857   0.004  0.169
## 9  Invertebrate vs. Fish lakeOklawaha  0.913       0.476  1.918   0.055  2.492
## 10 Invertebrate vs. Fish lakeTrafford  1.156       0.493  2.345   0.019  3.177
## 11 Invertebrate vs. Fish      sexmale -0.463       0.396 -1.171   0.242  0.629
## 12 Invertebrate vs. Fish    sizesmall  1.336       0.411  3.250   0.001  3.805
## 13        Other vs. Fish  (Intercept) -1.721       0.631 -2.726   0.006  0.179
## 14        Other vs. Fish  lakeHancock  0.767       0.569  1.348   0.178  2.152
## 15        Other vs. Fish lakeOklawaha  0.026       0.778  0.033   0.973  1.026
## 16        Other vs. Fish lakeTrafford  1.558       0.626  2.490   0.013  4.748
## 17        Other vs. Fish      sexmale -0.253       0.466 -0.542   0.588  0.777
## 18        Other vs. Fish    sizesmall  0.291       0.460  0.632   0.528  1.337
## 19      Reptile vs. Fish  (Intercept) -2.859       1.146 -2.496   0.013  0.057
## 20      Reptile vs. Fish  lakeHancock  1.129       1.193  0.947   0.344  3.094
## 21      Reptile vs. Fish lakeOklawaha  2.530       1.122  2.255   0.024 12.557
## 22      Reptile vs. Fish lakeTrafford  3.061       1.130  2.710   0.007 21.350
## 23      Reptile vs. Fish      sexmale -0.628       0.685 -0.916   0.360  0.534
## 24      Reptile vs. Fish    sizesmall -0.557       0.647 -0.862   0.389  0.573
\end{verbatim}
\end{kframe}
\end{knitrout}
